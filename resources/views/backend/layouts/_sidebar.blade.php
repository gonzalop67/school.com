<div class="page-sidebar">
    ...
    <ul class="x-navigation">
            ...
            <ul>
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="form-layouts-separated.html"><span class="fa fa-th-list"></span> Separated
                                Rows</a></li>
                    </ul>
                </li>
        ...
        <li class="xn-openable active">
            ...
            <ul>
                <li class="active"><a href="table-basic.html"><span class="fa fa-align-justify"></span> Basic</a>
                </li>
